                ...
                <div class="col-md-6">
                    <style>
                        ...
                        .search-input::placeholder {
                            color: #e0c0c0; /* Lighter color for better visibility */
                    ...
                    <input name="search_keyword" type="text" value="{{$query['search_keyword'] ?? null}}" placeholder="Search Templates" class="form-control search-input" style="background: #5f1b21;border-style: none;border-radius: 30px;color: #ffffff;">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-8">
