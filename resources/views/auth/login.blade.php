...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 items-center justify-center p-12">
        <div class="max-w-md text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">Join thousands of users who trust our platform for their needs</p>
            <div class="space-y-6">
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <div>
                        <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-all duration-200">
